...
2. Performance
   ...
   12. BUS Signals
       ...
       7. RFU
          1. RFU, or Reserved for Future Use, pins shall be connected between J1 and P1. This allows for the signals to be used in the future.
       8. EN_0, EN_1, EN_2
       ...
       10. P_GOOD
          ...
          6. The P_GOOD net shall be connected to both P1 and J1 to allow for the signal to pass through the module, regardless of if it is used or not.
3. Mechanical
    1. Connectors
